...
export const RESET_USER_OUT = 'reset_user_out' // 重置用户信息
export const RECEIVE_GOODS = 'receive_goods' // 接收商家点餐
export const RECEIVE_RATINGS = 'receive_ratings' // 接收商家评论
...
export const CLEANCART = 'cleancart' // 清空购物车
